...
export function EscalaWeekView({ currentDate, escalas, isAdmin }: EscalaWeekViewProps) {
  const days = useMemo(() => {
  ...
  return (
    <div className="flex flex-col h-full min-w-[1000px] overflow-x-auto">
      <div className="sticky top-0 z-10 grid grid-cols-[80px_repeat(7,1fr)] border-b bg-muted/30 backdrop-blur">
        ...
        {days.map(day => (
          <div key={day.toString()} className="border-r py-3 text-center last:border-r-0">
            <p className={cn(
